...
const insights = [
  {
    ...
    description: "Kaduna: 3 sites showing increasing turbidity. High contamination risk predicted within 48h.",
  ...
  },
  {
    ...
    description: "North-West region showing declining groundwater levels. Recommend immediate intervention.",
  ...
  },
  {
    ...
    description: "5 sites due for maintenance in next 7 days. Auto-scheduling recommended.",
  ...
  },
  {
    ...
    description: "Lagos: 2,400 additional people gained water access this week.",
          ...
          <div className="flex items-start gap-2">
            ...
            <div className="text-xs">
              ...
              <div className="text-muted-foreground">
                Monitoring 156 sites across Nigeria with 94% accuracy rate
              </div>
            </div>
          </div>
        </Card>
